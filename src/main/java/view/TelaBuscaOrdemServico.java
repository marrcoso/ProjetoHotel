...
public class TelaBuscaOrdemServico extends javax.swing.JDialog {

    public TelaBuscaOrdemServico(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("Busca de Ordens de Serviço");
        ...
        jTableDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Data/Hora", "Check", "Serviço", "Quarto", "Previsão Início", "Previsão Término", "Status"
            }
        ) {
        ...
        if (jTableDados.getColumnModel().getColumnCount() > 0) {
            ...
            jTableDados.getColumnModel().getColumn(7).setMaxWidth(80);
        }
        ...
        jCBFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id", "Observação", "Status" }));
        ...
        jButtonAvancarStatus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Next.png"))); 
        jButtonAvancarStatus.setText("Próximo Status");
        jButtonAvancarStatus.setEnabled(false);

        jButtonCancelarPedido.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Cancel.png"))); 
        jButtonCancelarPedido.setText("Anular OS");
