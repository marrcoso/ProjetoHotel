 ...
 * @author house
 */
public class TelaBuscaCopaQuarto extends javax.swing.JDialog {

    /**
     * Creates new form TelaBuscaCopaQuarto
     */
    public TelaBuscaCopaQuarto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("Lançamentos de Copa Quarto");
        ...
        jTableDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Data/Hora", "Quarto", "Qtd", "Produto", "Total", "Obs", "Status"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaCopaQuarto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaBuscaCopaQuarto dialog = new TelaBuscaCopaQuarto(new javax.swing.JFrame(), true);
